...
public class DetailValidAdapter extends RecyclerView.Adapter<DetailValidAdapter.DetailValidViewHolder> {
    ...
    public  DetailValidAdapter(List<Pemesanan>daftarDetail){
    ...
    @NonNull
    @Override
    public DetailValidViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_detail_valid,parent,false);
        DetailValidViewHolder mHolder = new DetailValidAdapter.DetailValidViewHolder(view);
        return  mHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final DetailValidAdapter.DetailValidViewHolder holder, int position) {
    ...
    public class DetailValidViewHolder extends RecyclerView.ViewHolder {
        TextView namaKostum, jumlahSewa, hargaKostum, total;
        ImageView fotoKostum;
        public DetailValidViewHolder(@NonNull View itemView) {
            super(itemView);
