...
public class DetailPemesananAdapter extends RecyclerView.Adapter<DetailPemesananAdapter.DetailPemesananViewHolder> {
    ...
    public  DetailPemesananAdapter(List<Pemesanan>daftarDetail){
    ...
    public DetailPemesananViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_detail_pemesanan,parent,false);
       DetailPemesananViewHolder mHolder = new DetailPemesananViewHolder(view);
        return  mHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final DetailPemesananAdapter.DetailPemesananViewHolder holder, int position) {
    ...
    public class DetailPemesananViewHolder extends RecyclerView.ViewHolder {
