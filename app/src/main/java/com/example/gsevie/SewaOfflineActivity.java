...
import com.example.gsevie.Adapter.PesanOffAdapter;
...
public class SewaOfflineActivity extends AppCompatActivity {
    ...
    public PesanOffAdapter myAdapter;
    List<PesanOff> listSewa= new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sewa_offline);

        AppBarLayout appBarLayout = (AppBarLayout) findViewById(R.id.appbar);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Sewa");
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(SewaOfflineActivity.this, MenuBerandaActivity.class));
        finish();
    }


    public void tampilDaftarOff(){
        mApiInterface = APIClient.getClient().create(APIInterface.class);
        retrofit2.Call<GetPesanOff>mPesanOff = mApiInterface.tampilOff();
        ...
        mPesanOff.enqueue(new Callback<GetPesanOff>() {
            ...
            public void onResponse(retrofit2.Call<GetPesanOff> call, Response<GetPesanOff> response) {
                if(response.body().getStatus().equals("success")){
                    ...
                    listSewa = response.body().getResult();
                    myAdapter = new PesanOffAdapter(listSewa);
