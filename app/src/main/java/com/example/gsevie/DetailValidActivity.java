...
import com.example.gsevie.Adapter.DetailValidAdapter;
...
public class DetailValidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<GetPemesanan> putBukti= mApiInterface.putPinjam(reqid_sewa);
                putBukti.enqueue(new Callback<GetPemesanan>() {
                    ...
                    public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                        ...
                        Toast.makeText(getApplicationContext(),"Kostum sudah diambil",Toast.LENGTH_LONG).show();
                        Intent mIntent=  new Intent(getApplicationContext(),VerifikasiActivity.class);
    ...
    public void tampilDetail(){
        ...
        RequestBody reqid_sewa =MultipartBody.create(MediaType.parse("multipart/form-data"),
                id_sewa.getText().toString());
        Call<GetPemesanan> mDetailCall = mApiInterface.getDetailValid(reqid_sewa);
        mDetailCall.enqueue(new Callback<GetPemesanan>() {
            ...
            public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                ...
                mAdapter = new DetailValidAdapter(daftarDetail);
