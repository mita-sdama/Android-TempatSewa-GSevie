...
import com.example.gsevie.Adapter.DetailPemesananAdapter;
...
public class DetailPemesananActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tidakValid =(Button) findViewById(R.id.btBatal);
        ...
        buktiSewa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog= new Dialog(DetailPemesananActivity.this);
                dialog.setContentView(R.layout.layout_bukti);
                final ImageView bukti = (ImageView) dialog.findViewById(R.id.gambarBukti);
                ...
                mBukti.enqueue(new Callback<GetPemesanan>() {
                    ...
                    public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                        if(response.body().getStatus().equals("success")){
                            ...
                            if (photoName.equals("")){
                                Glide.with(getApplicationContext()).load(R.drawable.shopping).into(bukti);
                            }else{
                                Glide.with(getApplicationContext()).load(url_photo).into(bukti);
                            }
                        }
                    }
        ...
        valid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestBody reqid_sewa = MultipartBody.create(MediaType.parse("multipart/form-data"),
                        id_sewa.getText().toString());
                Call<GetPemesanan> putBukti= mApiInterface.putBukti(reqid_sewa);
                putBukti.enqueue(new Callback<GetPemesanan>() {
                    @Override
                    public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                        simpleProgressBar.setVisibility(View.GONE);
                        progressLayout.setVisibility(View.GONE);
                        Toast.makeText(getApplicationContext(),"Bukti pembayaran valid",Toast.LENGTH_LONG).show();
        ...
        tidakValid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ProgressBar simpleProgressBar= (ProgressBar) findViewById(R.id.simpleProgressBarr);
                final LinearLayout progressLayout = (LinearLayout) findViewById(R.id.progressLayout);
                ...
                RequestBody reqid_sewa = MultipartBody.create(MediaType.parse("multipart/form-data"),
                        id_sewa.getText().toString());
                Call<GetPemesanan> putBukti= mApiInterface.updateBatal(reqid_sewa);
                putBukti.enqueue(new Callback<GetPemesanan>() {
                    @Override
                    public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                        simpleProgressBar.setVisibility(View.GONE);
                        progressLayout.setVisibility(View.GONE);
                        Toast.makeText(getApplicationContext(),"Bukti pembayaran tidak valid",Toast.LENGTH_LONG).show();
                        Intent mIntent=  new Intent(getApplicationContext(),PemesananActivity.class);
                        startActivity(mIntent);
                    }
    ...
    public void tampilDetail(){
        ...
        RequestBody reqid_sewa =MultipartBody.create(MediaType.parse("multipart/form-data"),
                id_sewa.getText().toString());
        Call<GetPemesanan> mDetailCall = mApiInterface.getDetail(reqid_sewa);
        mDetailCall.enqueue(new Callback<GetPemesanan>() {
            ...
            public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                ...
                mAdapter = new DetailPemesananAdapter(daftarDetail);
        ...
        mBukti.enqueue(new Callback<GetPemesanan>() {
            ...
            public void onResponse(Call<GetPemesanan> call, Response<GetPemesanan> response) {
                if(response.body().getStatus().equals("success")){
                    ...
                    tidakValid.setVisibility(View.VISIBLE);
                }
            }
